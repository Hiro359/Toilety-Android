...
public class FavotiteListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.favorite_list_app_bar);
        toolbarTitle = (TextView) toolbar.findViewById(R.id.favoriteListTitleText);
...
//        UserInfo.longitude = centerLongitude;
    ...
    public void createRecyclerView(List toiletData) {
        ...
        recyclertView = (RecyclerView) findViewById(R.id.toiletFavoriteList);
